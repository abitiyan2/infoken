...
isset($_GET['cat'])?$category=$_GET['cat']:$category='';
...
$total_pages_sql = "SELECT COUNT(*) FROM books WHERE category = '".$selectedCategory."'";
$result = mysqli_query($conn, $total_pages_sql);
$numBooks = $total_rows = mysqli_fetch_array($result)[0];
...
<div class="display-4" style="margin-left: 200px; margin-top: 41px"><?=$selectedCategory?> (<?=$numBooks?>)</div>
<?php
$query = mysqli_query($conn, "SELECT * FROM books WHERE category = '".$selectedCategory."' LIMIT $offset, $no_of_records_per_page");
?>
