...
$total_pages_sql = "SELECT COUNT(*) FROM books ORDER BY numRent DESC LIMIT 15";
...
<?php
$query = mysqli_query($conn, "SELECT * FROM books ORDER BY numRent DESC LIMIT 15");
?>

<div class="row" style="margin-left: 150px; margin-top: 41px">
    <?php
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 m-2">
                <div class="card" style="width: 220px;">
                    ...
                    <div class="card-body text-center">
                        <h6 class="card-title"><?= $row["title"]?><span class="badge badge-info"><?=$row["numRent"]?></span></h6>
