...
$total_pages_sql = "SELECT COUNT(*), SUM(totalCopies) FROM books ";
...
<div class="cotainer justify-content-end" style="margin-left: 170px; margin-top: 41px">
    <div class="alert alert-warning alert-dismissible fade show" style="width: 1020px">
        <strong>Available</strong>(<?= $availableBooks ?>).<strong> All Books</strong>(<?=$allBooks?>).<strong> Distinct</strong>(<?=$numBooks?>).
        <button type="button" class="close" data-dismiss="alert">×</button>
    </div>
</div>

<?php
$query = mysqli_query($conn, "SELECT * FROM books LIMIT $offset, $no_of_records_per_page");
?>
