...
<body>
    <div class="container">
        ...
        <p>Scroll the scrollable area and the JavaScript code will show the name of highlighted nav item. If you remove any section using the "Remove this section" link the scorllspy automatically refreshed in order to highlight the menu items based on the available target element.</p>
        <nav id="myNavbar" class="navbar navbar-expand-md navbar-dark bg-dark mb-3">
    	...
    	<div class="section">
            <h3 id="section1">Section 1 <small><a href="#" onclick="removeSection(this);">&times; Remove this section</a></small></h3>
        ...
        <hr>
        <div class="section">
            <h3 id="section2">Section 2 <small><a href="#" onclick="removeSection(this);">&times; Remove this section</a></small></h3>
        ...
        <hr>
        <div class="section">
            <h3 id="section3">Section 3 <small><a href="#" onclick="removeSection(this);">&times; Remove this section</a></small></h3>
        ...
        <div class="section">
            <h4 id="section4dot1">Section 4.1 <small><a href="#" onclick="removeSection(this);">&times; Remove this section</a></small></h4>
        ...
        <div class="section">
            <h4 id="section4dot2">Section 4.2 <small><a href="#" onclick="removeSection(this);">&times; Remove this section</a></small></h4>
        ...
        <div class="section">
            <h4 id="section4dot3">Section 4.3 <small><a href="#" onclick="removeSection(this);">&times; Remove this section</a></small></h4>
        ...
        <hr>
        <div class="section">
            <h3 id="section5">Section 5 <small><a href="#" onclick="removeSection(this);">&times; Remove this section</a></small></h3>
            <p>Nam eget purus nec est consectetur vehicula. Nullam ultrices nisl risus, in viverra libero egestas sit amet. Etiam porttitor dolor non eros pulvinar malesuada. Vestibulum sit amet est mollis nulla tempus aliquet. Praesent luctus hendrerit arcu non laoreet. Morbi consequat placerat magna, ac ornare odio sagittis sed. Donec vitae ullamcorper purus. Vivamus non metus ac justo porta volutpat.</p>
